...
public final class UBTNKST3 extends Block <UBTNKST3>
{
	...
	public @StringType(init="1") Attribute<String> bp9;
	public @StringType(init="8") Attribute<String> bp10;
	public @StringType(init="1") Attribute<String> bp11;
