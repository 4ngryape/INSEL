...
C     #IN(6) Ambient temperature / \degC
C     #IN(7) Sky temperature / \degC
C     #IN(8) Wind speed / m\,s$^{-1}$
C     #IN(9) Interior Temperature / °C
...
C        surface is called RP(4+nlay+1) and is the old temperature
     ...
     &          * (C2L * TLAYER2 + IN(2) + HCI*IN(9) + IN(3) + IN(4)
     &          + HRI * TOLD(1,1)))
