...
C-----------------------------------------------------------------------
     ...
     &,                GROUP  = 3)
      ...
      REAL             Tnutz, Kosten, Zins, Invest, Annuitaet
C-----------------------------------------------------------------------
      IF (IP(2) .NE. 0) THEN
         IF (IP(2) .EQ. -1) THEN
...
c---- Standard call ----------------------------------------------------
      ...
      Annuitaet = Zins*((1+Zins)**Tnutz)/(((1+Zins)**Tnutz)-1)
      Kosten = Invest * Annuitaet
