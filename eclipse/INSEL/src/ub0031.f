...
C     #IN(11) Any other input 1
C     #in(19) Any other input 2
C     #IN(13) Any other input 3
C  #Outputs
...
C     #OUT(4) $U$-value / W\,m$^{-2}$\,K$^{-1}$ C     #OUT(5) Any interesting output 1
...
C           Outside heat transfer coefficient
            ...
            !HCO     = HCO + 3.68*IN(9)         !http://editorial.cda.ulpgc.es/ftp/ambiente/antesol/TESIS/Cap4.pdf
            GSOLAR  = IN(6)
            TA      = IN(7)
