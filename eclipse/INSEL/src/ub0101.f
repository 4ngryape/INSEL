...
C-----------------------------------------------------------------------
     ...
     &,                GROUP  = 3)
      ...
      REAL             Tnutz, Kosten, Zins, Invest, Inflation,
     &                 Anteilinvest, Minflation
C-----------------------------------------------------------------------
      IF (IP(2) .NE. 0) THEN
         IF (IP(2) .EQ. -1) THEN
...
c---- Standard call ----------------------------------------------------
      ...
      Minflation =(1+Inflation)/
     &(Zins-Inflation)*Zins*((1+Zins)**Tnutz-
     &(1+Inflation)**Tnutz)/((1+Zins)**Tnutz-1)

      Kosten = Invest * Anteilinvest * Minflation
