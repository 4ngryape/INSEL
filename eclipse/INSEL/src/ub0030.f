...
C     #IN(3) Convective heat flux from the room air / W\,m$^{-2}$   NOT ANYMORE AN INPUT!!!!!
...
C     #IN(7) Convective heat flux from exterior air / W\,m$^{-2}$   NOT ANYMORE AN INPUT!!!!!
C     #IN(8) Longwave heat flux from exterior surfaces and sky / W\,m$^{-2}$
C     #IN(9) Radiative part of exterior heat sources / W\,m$^{-2}$
C     #IN(10) Interior Temperature / °C
C     #IN(11) Exterior Temperature / °C
...
C     #OUT(3) Any other output 1
C     #OUT(4) Any other output 2
C     #OUT(5) $U$-value / W\,m$^{-2}$\,K$^{-1}$
...
C        surface is called RP(4+nlay+1) and is the old temperature
     ...
     &          * (C2L * TLAYER2 + IN(2) + HCI*IN(10) + IN(4) + IN(5)
     &          + HRI * TOLD(1,1)))
...
C           Outside heat transfer coefficient
            !HCOWIND = 3.575 * IN(9) !to be changed
